...
it creates a cert that is not trusted by browser (or) system. so its only useful for development & testing & internal systems where public trust is not required.
